...
class FieldsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create field" do
    assert_difference("Field.count") do
      post fields_url, params: { field: { field_type_id: @field.field_type_id, submission_id: @field.submission_id, value: @field.value } }
    end
  ...
  test "should update field" do
    patch field_url(@field), params: { field: { field_type_id: @field.field_type_id, submission_id: @field.submission_id, value: @field.value } }
